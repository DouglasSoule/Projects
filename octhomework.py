...
def write_output_sentence(geolocator):
    # print(geolocator)
    print(f'Some stuff about where I do journalism for school: I do journalistic things at {geolocator["clean_address"][:-5]}, at latitude {geolocator["latitude"]} and longitude {geolocator["longitude"]}, in {geolocator["county"]}, {geolocator["state_long"]}, {geolocator["country"]}.')
